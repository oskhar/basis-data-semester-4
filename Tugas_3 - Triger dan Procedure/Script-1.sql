...
CREATE TABLE peminjaman (
    ...
    id_pegawai INT NOT NULL UNIQUE,
...
VALUES
    (1, 1, '11220910000042', 5, '2023-09-01', '2023-09-06', 750000, 250000, 500000, 'aktif', 'tidak', GETDATE()),
    (2, 2, '11220910000043', 3, '2023-09-02', '2023-09-05', 600000, 200000, 400000, 'aktif', 'tidak', GETDATE()),
    (3, 3, '11220910000044', 4, '2023-09-03', '2023-09-07', 720000, 240000, 480000, 'aktif', 'tidak', GETDATE()),
    (1, 2, '11220910000043', 3, '2023-10-02', '2023-10-05', 600000, 200000, 400000, 'aktif', 'tidak', GETDATE()),
    (2, 3, '11220910000044', 4, '2023-10-03', '2023-10-07', 720000, 240000, 480000, 'aktif', 'tidak', GETDATE());
